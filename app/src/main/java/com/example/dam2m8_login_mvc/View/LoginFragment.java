package com.example.dam2m8_login_mvc.View;
...
public class LoginFragment extends Fragment {
    ...
    private EditText userEditText, pswdEditText;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mListener.checkLogin(userEditText.getText().toString(),
                        pswdEditText.getText().toString()) == true){
    ...
    public interface LoginListener {
        ...
        Boolean checkLogin(String user, String passwd);
    }
}
